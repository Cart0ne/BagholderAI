...
| PARKED_tf_volume_analysis_framework.md | 2026-06-22 (S108) | Gambe 2+3 analisi volume TF: backtest EMA/RSI su dati storici Binance (verifica soglia ~2M) + bibliografia volume/breadth/social. Caso 2 (non blocca go-live), non dipende dal barometro. Trigger: sessione di lavoro CC dedicata (~2-3 sessioni). |
