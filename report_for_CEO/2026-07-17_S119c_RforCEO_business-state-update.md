...
- **§4 Decisioni** — +7 righe (in cima): primo ordine reale · funding EUR→USD · no-annuncio test · status line corretta · trigger reale ~~$65.271~~ **$66.314** *(corretto 2026-07-20: la formula è fee-buffered `grid_bot.py:876`, non avg×1,02)* · nodo 5 anticipato · riavvio sicuro incondizionato.
