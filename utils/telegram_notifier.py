...
class TelegramNotifier:
    ...
    async def send_private_daily_report(self, data: dict) -> bool:
        ...
        text += f"\n🤖 <i>Grid bot v3 · <a href=\"https://bagholderai.lol/?utm_source=telegram&amp;utm_medium=social&amp;utm_campaign=daily_report\">bagholderai.lol</a></i>"
        return await self.send_message(text)
    ...
    async def send_public_commentary(self, commentary_text: str) -> bool:
        ...
        text = (
            ...
            f"{commentary_text}\n"
            f"\n"
            f"🤖 <i>Generated by Haiku · Same as <a href=\"https://bagholderai.lol/dashboard?utm_source=telegram&amp;utm_medium=social&amp;utm_campaign=daily_report\">bagholderai.lol/dashboard</a></i>"
        )
