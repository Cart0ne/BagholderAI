  ...
  phases: [
    ...
    },
    {
      ...
      tasks: [
        ...
        { section: "Phase 13 — Binance Testnet & Avg-Cost Reset (S65 → S79)" },
    ...
    },
    {
      ...
      tasks: [
        ...
        { text: "Project memories review (obsolescence check)", status: "done", who: "AI", comment: "S79 (2026-05-18) review effettuato: memorie FIFO-frame ereditate da S65-66 erano stale dopo S69 avg-cost migration. Bonifica project_equity_pnl_vs_fifo + feedback_one_source_of_truth + project_57a_fifo_punto_fisso + project_60c_fifo_init_bug — canonical ora avg-cost + Equity P&L (FIFO non esiste su exchange). Pattern: review opportunistica quando un drift emerge, non scheduled." },
        ...
        { text: "Wallet reconciliation Step C (nightly cron Mac Mini)", status: "done", who: "AI", comment: "Shipped S72 (2026-05-11). Cron 03:00 Europe/Rome attivo su Mac Mini, prima run automatica 2026-05-12 ok. TCC FDA per python3.13 abilitata S74." },
