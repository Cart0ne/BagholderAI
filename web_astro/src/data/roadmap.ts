  ...
  phases: [
    ...
    },
    {
      ...
      tasks: [
        ...
        { text: "Sherpa Sprint 2 observation window (7-10 days)", status: "done", who: "AI", comment: "Closed. Brain Analysis #2 (S91) cleared the per-coin rework; a multi-agent coherence audit (S102) confirmed Sherpa is coin-agnostic across all 5 regimes. Gate passed → SHERPA_MODE=live." },
