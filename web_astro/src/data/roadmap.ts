  ...
  phases: [
    ...
    },
    {
      ...
      tasks: [
        ...
        { text: "Sentinel Sprint 2: slow loop (Fear & Greed + CMC dominance + regime detection)", status: "todo", who: "BOTH", comment: "Brief 78a in planning (post-S77). The real opp-score multiplier: F&G and regime detection will compensate for funding signal being dead on testnet." },
