...
export const mockTools = [
  ...
  },
  {
    ...
    pnlPct:   null,
    days:     null,
    blurb:    "Risk officer. Reads risk + the macro regime from price, funding, and Fear & Greed.",
  },
  {
    key:      "newskeeper",
    name:     "NewsKeeper",
    ...
    pnlPct:   null,
    days:     null,
    blurb:    "News watcher. Classifies crypto headlines by severity and signal — the macro early-warning.",
  },
  {
    key:      "sherpa",
    name:     "Sherpa",
    ...
    pnlPct:   null,
    days:     null,
    blurb:    "Parameter tuner. Turns Sentinel's regime reads into per-coin Grid settings.",
  },
];
